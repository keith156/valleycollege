        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 grid-flow-dense gap-4 sm:gap-6 auto-rows-[250px] md:auto-rows-[300px] max-w-[1600px] mx-auto">
            {[
              ...
              "12$Deputy and some prefects.webp", "13$S.4 CLASS (Girls) 2025.webp", "14$S.4 CLASS (Girls) 2025.webp", "final_15$S.4 Class (boys) 2025.webp", 
              "final_16$S.4 Class (boys) 2025.webp", "final_18$S.4 class 2024, after briefing.webp", "final_20$S.4 Class (boys) 2025.webp", 
