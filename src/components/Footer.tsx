      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-blue-800 pt-8 flex flex-col items-center justify-center gap-4 text-xs text-blue-300 text-center">
          ...
          <div className="flex justify-center gap-5 mb-2">
            <a href="https://www.facebook.com/ValleyCollegeBushenyi/" target="_blank" rel="noopener noreferrer" aria-label="Valley College on Facebook" className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition-colors">
            ...
            <a href="https://x.com/valley_college" target="_blank" rel="noopener noreferrer" aria-label="Valley College on X (Twitter)" className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition-colors">
            ...
            <a href="https://www.tiktok.com/discover/valley-college-schoolbushenyi-uganda" target="_blank" rel="noopener noreferrer" aria-label="Valley College on TikTok" className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition-colors">
            ...
            <a href="https://www.instagram.com/explore/locations/1030965624/valley-college-bushenyi/" target="_blank" rel="noopener noreferrer" aria-label="Valley College on Instagram" className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition-colors">
